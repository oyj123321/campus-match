...
(function () {
    ...
    zh: {
        ...
        'incomplete.matchesBody': '完成隐私模式资料或完整问卷（含学历）后才能预约与匹配。点此继续。',
        ...
        'qn.edu': '学历 *',
        'qn.edu.hint': '须如实填写。默认只配同学历；勾选跨学历后，对方也须勾选才会配对。',
    ...
    tw: {
        ...
        'incomplete.matchesBody': '完成隱私模式資料或完整問卷（含學歷）後才能預約與配對。點此繼續。',
        ...
        'qn.edu': '學歷 *',
        'qn.edu.hint': '須如實填寫。預設只配同學歷；勾選跨學歷後，對方也須勾選才會配對。',
    ...
    en: {
        ...
        'incomplete.matchesBody': 'Finish Privacy mode or the full survey (including your degree) before you can opt in or match. Tap to continue.',
        ...
        'qn.edu': 'Degree *',
        'qn.edu.hint': 'Required. Same degree by default; cross-degree only if both of you opt in.',
    ...
    pt: {
        ...
        'incomplete.matchesBody': 'Conclui o modo privacidade ou o questionário completo (incluindo o grau) antes de te inscreveres. Toca para continuar.',
        ...
        'qn.edu': 'Grau *',
        'qn.edu.hint': 'Obrigatório. Por defeito só o mesmo grau; cruzar graus só se ambos marcarem.',
