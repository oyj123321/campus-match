...
(function () {
    ...
    zh: {
        ...
        'hero.sub': '学校邮箱验证在校身份 → 40 题走心问卷 → 每周一对一揭晓，附相处说明书与破冰话题。慢一点，但更认真。',
        ...
        'step01.h': '答一份走心问卷', 'step01.p': '40 道题覆盖价值观、生活习惯、情感风格、兴趣与相处预期，可标记「对我很重要」加权。',
        'step02.h': '预约本周匹配', 'step02.p': '每周统一揭晓一位一对一对象：昵称、契合度、相处说明书，以及为什么是 TA。',
        'step03.h': '照着破冰开聊', 'step03.p': '配对成功互见微信号，附 3 条按你们答卷生成的破冰话题——开口不再尴尬。',
        'why.title': '我们和「刷脸软件」不一样',
        'feat1.h': '只限在校生', 'feat1.p': '仅支持列表内学校邮箱注册，你遇到的每个人都经过校园身份验证。',
        'feat2.h': '一周一位，宁缺毋滥', 'feat2.p': '没有无限右滑。每周额度限一位，双方取向互相接受、硬性底线不冲突才配对。',
        'feat3.h': '隐私优先', 'feat3.p': '资料不公开陈列；微信号只在配对成功后互见，还可拉黑不想遇到的人。',
        'feat4.h': '告诉你「为什么是 TA」', 'feat4.p': '不只给分数：相处说明书列出共同点、需要包容的差异和聊天切入点。',
        'privacy.title': '使用说明 & 隐私',
        'privacy.li1': '仅接受支持列表内的学校邮箱注册，用于确认在校身份。',
        'privacy.li2': '问卷与择偶取向用于匹配；微信号仅在匹配成功后发送给对方。',
        'privacy.li3': '每周有匹配额度与冷却，结果以网站页面为准（邮件只是通知）。',
        ...
        // 问卷页
        'qn.title': '填写资料 & 问卷', 'qn.sub1': '共', 'qn.sub2': '题 · 请点选作答；未选不算已答',
        ...
        'qn.wechat': '微信号 *', 'qn.wechat.ph': '匹配成功后发送给对方', 'qn.bio': '一句话介绍',
        'qn.bio.ph': '例：大三心理学在读，喜欢猫咪和下雨天',
        'qn.cross': '允许跨校匹配（双方都开才生效）', 'qn.cross.hint': '默认同校；勾选后可与其它支持学校的同学配对。',
        ...
        'card.assigned': '系统派单', 'card.manual': '相处说明书', 'card.strengths': '共同点',
        'card.diff': '需要包容的差异', 'card.ice': '破冰话题（别让聊天死掉）',
        'card.wechat': '微信: ', 'card.nowechat': '未填写',
        'card.opener': '开口可以很简单：「嗨，CampusMatch 匹配到的，看到破冰话题想先问你第一个…」',
        'btn.noMore': '不再匹配此人',
    ...
    tw: {
        ...
        'hero.sub': '學校信箱驗證在校身份 → 40 題走心問卷 → 每週一對一揭曉，附相處說明書與破冰話題。慢一點，但更認真。',
        ...
        'step01.h': '答一份走心問卷', 'step01.p': '40 道題涵蓋價值觀、生活習慣、情感風格、興趣與相處預期，可標記「對我很重要」加權。',
        'step02.h': '預約本週配對', 'step02.p': '每週統一揭曉一位一對一對象：暱稱、契合度、相處說明書，以及為什麼是 TA。',
        'step03.h': '照著破冰開聊', 'step03.p': '配對成功互見微信號，附 3 條按你們答卷生成的破冰話題——開口不再尷尬。',
        'why.title': '我們和「刷臉軟體」不一樣',
        'feat1.h': '只限在校生', 'feat1.p': '僅支援列表內學校信箱註冊，你遇到的每個人都經過校園身份驗證。',
        'feat2.h': '一週一位，寧缺毋濫', 'feat2.p': '沒有無限右滑。每週額度限一位，雙方取向互相接受、硬性底線不衝突才配對。',
        'feat3.h': '隱私優先', 'feat3.p': '資料不公開陳列；微信號只在配對成功後互見，還可封鎖不想遇到的人。',
        'feat4.h': '告訴你「為什麼是 TA」', 'feat4.p': '不只給分數：相處說明書列出共同點、需要包容的差異和聊天切入點。',
        'privacy.title': '使用說明 & 隱私',
        'privacy.li1': '僅接受支援列表內的學校信箱註冊，用於確認在校身份。',
        'privacy.li2': '問卷與擇偶取向用於配對；微信號僅在配對成功後發送給對方。',
        'privacy.li3': '每週有配對額度與冷卻，結果以網站頁面為準（郵件只是通知）。',
        ...
        'qn.title': '填寫資料 & 問卷', 'qn.sub1': '共', 'qn.sub2': '題 · 請點選作答；未選不算已答',
        ...
        'qn.wechat': '微信號 *', 'qn.wechat.ph': '配對成功後發送給對方', 'qn.bio': '一句話介紹',
        'qn.bio.ph': '例：大三心理學在讀，喜歡貓咪和下雨天',
        'qn.cross': '允許跨校配對（雙方都開才生效）', 'qn.cross.hint': '預設同校；勾選後可與其它支援學校的同學配對。',
        ...
        'card.assigned': '系統派單', 'card.manual': '相處說明書', 'card.strengths': '共同點',
        'card.diff': '需要包容的差異', 'card.ice': '破冰話題（別讓聊天死掉）',
        'card.wechat': '微信: ', 'card.nowechat': '未填寫',
        'card.opener': '開口可以很簡單：「嗨，CampusMatch 配對到的，看到破冰話題想先問你第一個…」',
        'btn.noMore': '不再配對此人',
    ...
    en: {
        ...
        'hero.sub': 'Verify with your school email → a thoughtful 40-question survey → one 1-on-1 match revealed weekly, with a compatibility guide and icebreakers. Slower, but more sincere.',
        ...
        'step01.h': 'Take a thoughtful survey', 'step01.p': '40 questions on values, lifestyle, emotional style, interests and expectations. Mark what matters most to weight it higher.',
        'step02.h': 'Opt in for this week', 'step02.p': 'One 1-on-1 match revealed each week: their name, compatibility score, a guide to getting along — and why them.',
        'step03.h': 'Break the ice', 'step03.p': 'Once matched you exchange WeChat IDs, plus 3 icebreakers generated from your answers — no awkward openers.',
        ...
        'feat2.h': 'One match a week', 'feat2.p': 'No endless swiping. One match per week, only when preferences are mutual and dealbreakers don\u2019t clash.',
        'feat3.h': 'Privacy first', 'feat3.p': 'No public profiles. WeChat IDs are shared only after a successful match, and you can block anyone.',
        'feat4.h': 'Know why it\u2019s them', 'feat4.p': 'More than a score: a guide listing what you share, differences to embrace, and where to start chatting.',
        'privacy.title': 'How it works & privacy',
        'privacy.li1': 'Only supported school emails can register, to verify student identity.',
        'privacy.li2': 'Survey answers and preferences are used for matching; WeChat IDs are shared only after a match.',
        'privacy.li3': 'Weekly quotas and cooldowns apply; the website is the source of truth (email is just a notification).',
        ...
        'qn.title': 'Profile & Questionnaire', 'qn.sub1': '', 'qn.sub2': 'questions · tap to answer; unselected doesn\u2019t count',
        ...
        'qn.wechat': 'WeChat ID *', 'qn.wechat.ph': 'Shared with your match on success', 'qn.bio': 'One-line intro',
        'qn.bio.ph': 'e.g. Psychology junior, loves cats and rainy days',
        'qn.cross': 'Allow cross-school matching (both sides must enable)', 'qn.cross.hint': 'Same school by default; enable to match students from other supported schools.',
        ...
        'qn.needWechat': 'Please enter your WeChat ID (shared after a match)', 'qn.missing': 'Some questions are unanswered — finish them first',
        ...
        'dim.interests': 'Interests', 'dim.expectations': 'Expectations',
        ...
        'hdr.answered': 'Answered', 'hdr.q': 'questions', 'hdr.noq': 'Survey not done', 'hdr.cross': 'Cross-school', 'on': 'on', 'off': 'off',
        ...
        'card.diff': 'Differences to embrace', 'card.ice': 'Icebreakers (keep the chat alive)',
        'card.wechat': 'WeChat: ', 'card.nowechat': 'not set',
        'card.opener': 'Opening is easy: "Hi, matched on CampusMatch — the first icebreaker made me curious…"',
    ...
    pt: {
        ...
        'hero.sub': 'Verificação com email escolar → 40 perguntas com alma → um match 1-a-1 revelado por semana, com guia de convivência e quebra-gelos. Mais devagar, mas mais a sério.',
        ...
        'step01.h': 'Responde a um questionário com alma', 'step01.p': '40 perguntas sobre valores, estilo de vida, estilo emocional, interesses e expectativas. Marca o que mais importa para dar mais peso.',
        'step02.h': 'Inscreve-te esta semana', 'step02.p': 'Um match 1-a-1 revelado por semana: nome, compatibilidade, guia de convivência — e porquê essa pessoa.',
        'step03.h': 'Quebra o gelo', 'step03.p': 'Com match feito trocam IDs de WeChat, mais 3 quebra-gelos gerados a partir das vossas respostas — sem inícios constrangedores.',
        ...
        'feat2.h': 'Um match por semana', 'feat2.p': 'Sem swipes infinitos. Um match por semana, só com preferências mútuas e sem conflitos de limites.',
        'feat3.h': 'Privacidade primeiro', 'feat3.p': 'Sem perfis públicos. IDs de WeChat só após match, e podes bloquear quem quiseres.',
        'feat4.h': 'Sabe porquê essa pessoa', 'feat4.p': 'Mais do que uma pontuação: um guia com o que partilham, diferenças a aceitar e por onde começar a conversa.',
        ...
        'privacy.li2': 'Respostas e preferências servem para o matching; o WeChat só é partilhado após match.',
        'privacy.li3': 'Há quotas semanais e tempos de espera; o site é a fonte oficial (o email é só notificação).',
        ...
        'qn.title': 'Perfil & Questionário', 'qn.sub1': '', 'qn.sub2': 'perguntas · toca para responder; sem seleção não conta',
        ...
        'qn.wechat': 'ID de WeChat *', 'qn.wechat.ph': 'Partilhado com o teu match', 'qn.bio': 'Intro numa frase',
        'qn.bio.ph': 'ex.: 3º ano de Psicologia, adora gatos e dias de chuva',
        'qn.cross': 'Permitir matching entre escolas (ambos têm de ativar)', 'qn.cross.hint': 'Por defeito é a mesma escola; ativa para conhecer estudantes de outras escolas suportadas.',
        ...
        'qn.needWechat': 'Introduz o teu WeChat (partilhado após match)', 'qn.missing': 'Há perguntas por responder — termina primeiro',
        ...
        'dim.interests': 'Interesses', 'dim.expectations': 'Expectativas',
        ...
        'hdr.answered': 'Respondeu', 'hdr.q': 'perguntas', 'hdr.noq': 'Questionário por fazer', 'hdr.cross': 'Entre escolas', 'on': 'sim', 'off': 'não',
        ...
        'card.assigned': 'O teu match', 'card.manual': 'Guia de convivência', 'card.strengths': 'O que partilham',
        'card.diff': 'Diferenças a aceitar', 'card.ice': 'Quebra-gelos (mantém a conversa viva)',
        'card.wechat': 'WeChat: ', 'card.nowechat': 'não definido',
        'card.opener': 'Começar é fácil: "Olá, match do CampusMatch — o primeiro quebra-gelo deixou-me curioso(a)…"',
