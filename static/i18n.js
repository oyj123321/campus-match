...
(function () {
    ...
    zh: {
        ...
        'priv.pageTitle': '隐私政策', 'priv.updated': '更新日期：2026-07-31 · 适用于 CampusMatch 网站服务（内测阶段）',
        'priv.back': '返回首页',
        // 首页
        ...
        'privacy.li4': '可随时退出登录；删除账号请用注册学校邮箱联系页脚邮箱，并阅读《隐私政策》。',
        ...
        'mbti.title': '问卷推演 MBTI', 'mbti.sub': '根据恋爱问卷近似映射，仅供参考。',
        'mbti.self': '关于你：', 'mbti.love': '恋爱中：', 'mbti.caution': '需要注意：', 'mbti.compat': '更合拍类型：',
        'mbti.disc': '本结果由恋爱问卷近似映射，并非正式 MBTI 测验，仅供娱乐与破冰参考。',
    ...
    tw: {
        ...
        'priv.pageTitle': '隱私政策', 'priv.updated': '更新日期：2026-07-31 · 適用於 CampusMatch 網站服務（內測階段）',
        'priv.back': '返回首頁',
        ...
        'privacy.li4': '可隨時登出；刪除帳號請用註冊學校信箱聯絡頁尾信箱，並閱讀《隱私政策》。',
        ...
        'mbti.title': '問卷推演 MBTI', 'mbti.sub': '根據戀愛問卷近似映射，僅供參考。',
        'mbti.self': '關於你：', 'mbti.love': '戀愛中：', 'mbti.caution': '需要注意：', 'mbti.compat': '更合拍類型：',
        'mbti.disc': '本結果由戀愛問卷近似映射，並非正式 MBTI 測驗，僅供娛樂與破冰參考。',
    ...
    en: {
        ...
        'priv.pageTitle': 'Privacy Policy', 'priv.updated': 'Updated: 2026-07-31 · CampusMatch (beta)',
        ...
        'privacy.li4': 'Log out anytime; to delete your account, email us from your school address (see footer) and read the Privacy Policy.',
        ...
        'mbti.title': 'Survey-mapped MBTI', 'mbti.sub': 'Approximate mapping from the dating survey — for reference only.',
        'mbti.self': 'About you: ', 'mbti.love': 'In relationships: ', 'mbti.caution': 'Watch for: ', 'mbti.compat': 'Often compatible: ',
        'mbti.disc': 'Mapped from our survey, not a formal MBTI test. For entertainment and icebreaking only.',
    ...
    pt: {
        ...
        'priv.pageTitle': 'Política de privacidade', 'priv.updated': 'Atualizado: 2026-07-31 · CampusMatch (beta)',
        ...
        'privacy.li4': 'Sai quando quiseres; para eliminar a conta escreve do email escolar (ver rodapé) e lê a Política de privacidade.',
        ...
        'mbti.title': 'MBTI a partir do questionário', 'mbti.sub': 'Mapeamento aproximado — apenas referência.',
        'mbti.self': 'Sobre ti: ', 'mbti.love': 'Em relações: ', 'mbti.caution': 'Atenção: ', 'mbti.compat': 'Tipos mais compatíveis: ',
        'mbti.disc': 'Mapeado a partir do questionário, não é um teste MBTI oficial. Só para entretenimento.',
