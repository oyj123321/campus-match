...
(function () {
    ...
    zh: {
        ...
        'step03.h': '照着破冰开聊', 'step03.p': '配对成功互见学校邮箱（可先邮件聊），也可另留微信；附破冰话题，开口不再尴尬。',
        ...
        'qn.wechat.hint': '配对成功后双方会互见已验证的学校邮箱，可先邮件开聊。若愿意，可再留微信等方便的联系方式。',
        'qn.bio': '一句话介绍',
        ...
        'qn.needWechat': '请填写联系方式（配对成功后会发给对方）', 'qn.missing': '还有未完成的题目，请先答完再提交',
        ...
        'card.diff': '需要包容的差异', 'card.ice': '军师支招',
        'card.ice.hint': '下面每条都有可直接发给 TA 的话，复制粘贴就行。',
    ...
    tw: {
        ...
        'step03.h': '照著破冰開聊', 'step03.p': '配對成功互見學校信箱（可先郵件聊），也可另留微信；附破冰話題，開口不再尷尬。',
        ...
        'qn.wechat': '附加聯絡方式（可選）',
        'qn.wechat.ph': '例如：wechat:mahuateng1998',
        'qn.wechat.hint': '配對成功後雙方會互見已驗證的學校信箱，可先郵件開聊。若願意，可再留微信等方便的聯絡方式。',
        'qn.bio': '一句話介紹',
        ...
        'qn.needWechat': '請填寫聯絡方式（配對成功後會發給對方）', 'qn.missing': '還有未完成的題目，請先答完再提交',
        ...
        'card.diff': '需要包容的差異', 'card.ice': '軍師支招',
        'card.ice.hint': '下面每條都有可直接發給 TA 的話，複製貼上就行。',
    ...
    en: {
        ...
        'step03.h': 'Break the ice', 'step03.p': 'Once matched you exchange school emails (chat by mail first); optional WeChat; plus icebreakers.',
        ...
        'feat3.h': 'Privacy first', 'feat3.p': 'No public profiles. School email and optional contacts are shared only after a match; you can block anyone.',
        ...
        'privacy.li2': 'Survey answers are used for matching; school emails are shared only after a match; WeChat etc. are optional.',
        ...
        'qn.wechat': 'Extra contact (optional)',
        'qn.wechat.ph': 'e.g. wechat:mahuateng1998',
        'qn.wechat.hint': 'After a match you both see verified school emails — start there. Optionally add WeChat etc.',
        ...
        'qn.needWechat': 'Please enter a contact (shared after a match)', 'qn.missing': 'Some questions are unanswered — finish them first',
        ...
        'card.diff': 'Differences to embrace', 'card.ice': 'Wingperson tips',
        'card.ice.hint': 'Each tip comes with a line you can copy-paste and send directly.',
    ...
    pt: {
        ...
        'step03.h': 'Quebra o gelo', 'step03.p': 'Com match feito trocam emails escolares (podem começar por email); WeChat opcional; mais quebra-gelos.',
        ...
        'feat3.h': 'Privacidade primeiro', 'feat3.p': 'Sem perfis públicos. Email escolar e contactos opcionais só após match; podes bloquear quem quiseres.',
        ...
        'privacy.li2': 'Respostas servem para matching; emails escolares só após match; WeChat etc. é opcional.',
        ...
        'qn.wechat': 'Contacto extra (opcional)',
        'qn.wechat.ph': 'ex.: wechat:mahuateng1998',
        'qn.wechat.hint': 'Após o match veem o email escolar verificado — podem começar por email. WeChat etc. é opcional.',
        ...
        'qn.needWechat': 'Introduz um contacto (partilhado após match)', 'qn.missing': 'Há perguntas por responder — termina primeiro',
        ...
        'card.diff': 'Diferenças a aceitar', 'card.ice': 'Dicas do conselheiro',
        'card.ice.hint': 'Cada dica tem uma frase para copiar e enviar diretamente.',
