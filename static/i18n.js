...
(function () {
    ...
    zh: {
        ...
        'incomplete.matchesBody': '完成隐私模式资料或完整问卷后才能预约与匹配。新用户还须填学历。点此继续。',
        ...
        'priv.pageTitle': '隐私政策', 'priv.updated': '更新日期：2026-09-03 · 适用于 CampusMatch 网站服务（内测阶段）',
        'priv.back': '返回首页',
        // 首页
        ...
        'cta.title': '准备好了？', 'cta.sub': '用学校邮箱开始。想少填隐私可用隐私模式，约 2 分钟。', 'cta.btn': '立即开始匹配',
        ...
        'qn.mode.title': '资料深度',
        'qn.mode.hint': '不想交太多隐私可以走隐私模式：学校邮箱已验证身份，再写一段话就能进同一匹配池。对方会看到你是隐私用户。完整问卷会更准。',
        'qn.mode.express': '隐私模式',
        'qn.mode.full': '完整问卷',
        ...
        'qn.express.submitHint': '不填 39 题。匹配会参考这段自我介绍，并与问卷用户在同一池。配对对象会被告知你是隐私用户。',
        'qn.express.submit': '保存隐私资料并进池',
        'qn.express.needBio': '请至少写 {n} 个字的自我介绍',
        'qn.express.saved': '已进入匹配池',
        ...
        'card.privacyBadge': '隐私用户',
        'card.privacyHint': '对方选择了隐私模式：没有填完整问卷，资料更少。请尊重边界，用学校邮箱慢慢聊。',
        'card.bio': '自我介绍',
    ...
    tw: {
        ...
        'incomplete.matchesBody': '完成隱私模式資料或完整問卷後才能預約與配對。新用戶還須填學歷。點此繼續。',
        ...
        'priv.pageTitle': '隱私政策', 'priv.updated': '更新日期：2026-09-03 · 適用於 CampusMatch 網站服務（內測階段）',
        'priv.back': '返回首頁',
        ...
        'cta.title': '準備好了？', 'cta.sub': '用學校信箱開始。想少填隱私可用隱私模式，約 2 分鐘。', 'cta.btn': '立即開始配對',
        ...
        'qn.mode.title': '資料深度',
        'qn.mode.hint': '不想交太多隱私可以走隱私模式：學校電郵已驗證身份，再寫一段話就能進同一配對池。對方會看到你是隱私用戶。完整問卷會更準。',
        'qn.mode.express': '隱私模式',
        'qn.mode.full': '完整問卷',
        ...
        'qn.express.submitHint': '不填 39 題。配對會參考這段自我介紹，並與問卷用戶在同一池。配對對象會被告知你是隱私用戶。',
        'qn.express.submit': '儲存隱私資料並進池',
        'qn.express.needBio': '請至少寫 {n} 個字的自我介紹',
        'qn.express.saved': '已進入配對池',
        ...
        'card.privacyBadge': '隱私用戶',
        'card.privacyHint': '對方選擇了隱私模式：沒有填完整問卷，資料更少。請尊重邊界，用學校電郵慢慢聊。',
        'card.bio': '自我介紹',
    ...
    en: {
        ...
        'incomplete.matchesBody': 'Finish Privacy mode or the full survey before you can opt in or match. New accounts also need a degree. Tap to continue.',
        ...
        'priv.pageTitle': 'Privacy Policy', 'priv.updated': 'Updated: 2026-09-03 · CampusMatch (beta)',
        ...
        'cta.title': 'Ready?', 'cta.sub': 'Start with your school email. Privacy mode takes about 2 minutes if you prefer less personal detail.', 'cta.btn': 'Start matching',
        ...
        'qn.mode.hint': 'If you do not want a long survey, use Privacy mode: school email already proves you are on campus; write a short intro and join the same pool. Your match will be told you are a privacy user. The full questionnaire matches more accurately.',
        'qn.mode.express': 'Privacy mode',
        'qn.mode.full': 'Full questionnaire',
        ...
        'qn.express.submitHint': 'Skip the 39 questions. Matching uses this intro, in the same pool. Your match will see that you chose Privacy mode.',
        'qn.express.submit': 'Save privacy profile & join pool',
        'qn.express.needBio': 'Please write at least {n} characters',
        'qn.express.saved': 'You are in the match pool',
        ...
        'lp.shareModes': 'Fast privacy · Deep questionnaire',
        ...
        'card.privacyBadge': 'Privacy user',
        'card.privacyHint': 'They chose Privacy mode: no full survey, so you will see less about them. Respect their boundary and start with school email.',
        'card.bio': 'Intro',
    ...
    pt: {
        ...
        'incomplete.matchesBody': 'Conclui o modo privacidade ou o questionário completo antes de te inscreveres. Contas novas também precisam do grau. Toca para continuar.',
        ...
        'priv.pageTitle': 'Política de privacidade', 'priv.updated': 'Atualizado: 2026-09-03 · CampusMatch (beta)',
        ...
        'cta.title': 'Pronto?', 'cta.sub': 'Começa com o teu email escolar. O modo privacidade leva cerca de 2 minutos se quiseres partilhar menos.', 'cta.btn': 'Começar o matching',
        ...
        'qn.mode.hint': 'Se não quiseres um questionário longo, usa o modo privacidade: o email escolar já prova que estás no campus; escreve um parágrafo e entras no mesmo pool. O teu match será informado de que és um utilizador de privacidade. O questionário completo acerta melhor.',
        'qn.mode.express': 'Modo privacidade',
        'qn.mode.full': 'Questionário completo',
        ...
        'qn.express.submitHint': 'Saltar as 39 perguntas. O matching usa este texto, no mesmo pool. O teu match verá que escolheste o modo privacidade.',
        'qn.express.submit': 'Guardar perfil de privacidade e entrar no pool',
        'qn.express.needBio': 'Escreve pelo menos {n} caracteres',
        'qn.express.saved': 'Entraste no pool de matching',
        ...
        'lp.shareModes': 'Privacidade rápida · Questionário detalhado',
        ...
        'card.privacyBadge': 'Utilizador de privacidade',
        'card.privacyHint': 'Escolheram o modo privacidade: sem questionário completo, por isso vês menos dados. Respeita o limite e começa pelo email escolar.',
