...
(function () {
    ...
    zh: {
        ...
        'incomplete.matchesBody': '完成问卷后才能预约与匹配。点此继续填写。',
    ...
    tw: {
        ...
        'incomplete.matchesBody': '完成問卷後才能預約與配對。點此繼續填寫。',
    ...
    en: {
        ...
        'incomplete.matchesBody': 'Finish the survey before you can opt in or match. Tap to continue.',
    ...
    pt: {
        ...
        'incomplete.matchesBody': 'Conclui o questionário antes de te inscreveres ou fazeres matching. Toca para continuar.',
