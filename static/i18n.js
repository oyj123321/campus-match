...
(function () {
    ...
    zh: {
        ...
        'incomplete.matchesBody': '完成隐私模式资料或完整问卷后才能预约与匹配。点此继续。',
    ...
    tw: {
        ...
        'incomplete.matchesBody': '完成隱私模式資料或完整問卷後才能預約與配對。點此繼續。',
    ...
    en: {
        ...
        'incomplete.matchesBody': 'Finish Privacy mode or the full survey before you can opt in or match. Tap to continue.',
    ...
    pt: {
        ...
        'incomplete.matchesBody': 'Conclui o modo privacidade ou o questionário completo antes de te inscreveres. Toca para continuar.',
