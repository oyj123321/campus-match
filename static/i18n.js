...
(function () {
    ...
    zh: {
        ...
        'privacy.li3': '每人每周最多匹配一次（双向）；结果只展示契合点与微信，不以分数衡量；以网站页面为准。',
    ...
    tw: {
        ...
        'privacy.li3': '每人每週最多配對一次（雙向）；結果只展示契合點與微信，不以分數衡量；以網站頁面為準。',
    ...
    en: {
        ...
        'privacy.li3': 'At most one match per person per week (both sides); results show shared points and WeChat, not a score; the website is the source of truth.',
    ...
    pt: {
        ...
        'privacy.li3': 'No máximo um match por pessoa por semana (ambos os lados); o resultado mostra pontos em comum e WeChat, não uma pontuação; o site é a fonte oficial.',
